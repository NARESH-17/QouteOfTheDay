...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    public static class AndroidxLifecycleLivedataLibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {
    ...
    public static class AndroidxLifecycleViewmodelKtxLibraryAccessors extends SubDependencyFactory {
        ...
        public AndroidxLifecycleViewmodelKtxLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
            ...
            /**
             * Creates a dependency provider for v284 (androidx.lifecycle:lifecycle-viewmodel-ktx)
             * This dependency was declared in catalog libs.versions.toml
             */
            public Provider<MinimalExternalModuleDependency> getV284() {
                return create("androidx.lifecycle.viewmodel.ktx.v284");
        }
